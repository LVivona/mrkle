...
from typing import Any, Final, Iterator, Literal, Optional, Protocol, Union

from typing_extensions import TypeAlias, override

from mrkle.crypto.typing import Digest
from mrkle.typing import BufferLike as Buffer
from mrkle.typing import File
...
class MrkleTreeSha3_224(_MrkleTreeBase):
    """Merkle tree using SHA3_224 hash algorithm."""

    def leaves(self) -> list[MrkleTreeSha3_224]: ...
    @staticmethod
    def dtype() -> Digest: ...
    @classmethod
    def from_leaves(
...
class MrkleTreeIterSha3_224(Iterator[Node_T]):
    """Iterator for SHA3_224 Merkle tree."""

    @override
    def __iter__(self) -> MrkleTreeIterSha3_224: ...
    @override
    def __next__(self) -> Node_T: ...

# SHA256
class MrkleTreeSha3_256(_MrkleTreeBase):
    """Merkle tree using SHA3_256 hash algorithm."""

    def leaves(self) -> list[MrkleTreeSha3_256]: ...
    @staticmethod
    def dtype() -> Digest: ...
    @classmethod
    def from_leaves(
...
class MrkleTreeIterSha3_256(Iterator[Node_T]):
    """Iterator for SHA3_256 Merkle tree."""

    @override
    def __iter__(self) -> MrkleTreeIterSha3_256: ...
    @override
    def __next__(self) -> Node_T: ...

# SHA384
class MrkleTreeSha3_384(_MrkleTreeBase):
    """Merkle tree using SHA3_384 hash algorithm."""

    def leaves(self) -> list[MrkleTreeSha3_384]: ...
    @staticmethod
    def dtype() -> Digest: ...
    @classmethod
    def from_leaves(
...
class MrkleTreeIterSha3_384(Iterator[Node_T]):
    """Iterator for SHA3_384 Merkle tree."""

    @override
    def __iter__(self) -> MrkleTreeIterSha3_384: ...
    @override
    def __next__(self) -> Node_T: ...

# SHA512
class MrkleTreeSha3_512(_MrkleTreeBase):
    """Merkle tree using SHA3_512 hash algorithm."""

    def leaves(self) -> list[MrkleTreeSha3_512]: ...
    @staticmethod
    def dtype() -> Digest: ...
    @classmethod
    def from_leaves(
...
class MrkleTreeIterSha3_512(Iterator[Node_T]):
    """Iterator for SHA512 Merkle tree."""

    @override
    def __iter__(self) -> MrkleTreeIterSha3_512: ...
    @override
    def __next__(self) -> Node_T: ...
...
class MrkleNodeSha3_224:
    """Merkle tree node using SHA3_224 hash algorithm."""
    ...
    def children(self) -> Sequence[int]: ...
    @staticmethod
    def leaf(payload: bytes) -> MrkleNodeSha3_224: ...
    @staticmethod
    def leaf_with_digest(payload: bytes, hash: bytes) -> Node_T: ...
    @staticmethod
    def dtype() -> Digest: ...
...
class MrkleNodeSha3_256:
    """Merkle tree node using SHA3_256 hash algorithm."""
    ...
    def children(self) -> Sequence[int]: ...
    @staticmethod
    def leaf(payload: bytes) -> MrkleNodeSha3_256: ...
    @staticmethod
    def leaf_with_digest(payload: bytes, hash: bytes) -> Node_T: ...
    @staticmethod
    def dtype() -> Digest: ...
...
class MrkleNodeSha3_384:
    """Merkle tree node using SHA3_384 hash algorithm."""
    ...
    def children(self) -> Sequence[int]: ...
    @staticmethod
    def leaf(payload: bytes) -> MrkleNodeSha3_384: ...
    @staticmethod
    def leaf_with_digest(payload: bytes, hash: bytes) -> Node_T: ...
    @staticmethod
    def dtype() -> Digest: ...
...
class MrkleNodeSha3_512:
    """Merkle tree node using SHA3_512 hash algorithm."""
    ...
    def children(self) -> Sequence[int]: ...
    @staticmethod
    def leaf(payload: bytes) -> MrkleNodeSha3_512: ...
    @staticmethod
    def leaf_with_digest(payload: bytes, hash: bytes) -> Node_T: ...
    @staticmethod
    def dtype() -> Digest: ...
